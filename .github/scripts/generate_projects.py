...
Theme: matches the profile banner (navy #0A0506, cyan #FF2020, violet #FF5A5F,
emerald #D11A2A, mono font, dotted leaders, pulsing dots, animated accents).
"""
...
THEMES = {
    "dark": {
        "BG": "#0A0506", "PANEL": "#120708", "PANEL_BAR": "#100607",
        "CYAN": "#FF2020", "VIOLET": "#FF5A5F", "VIOLET2": "#B00010",
        "EMERALD": "#D11A2A", "TEXT": "#FFF7F7", "MUTED": "#A3A3A3",
        "DIM": "#737373",
        "STROKE": "rgba(255,32,32,0.28)", "STROKE_HI": "rgba(255,32,32,0.5)",
        "STROKE_LO": "rgba(255,32,32,0.22)", "BARLINE": "rgba(255,255,255,0.08)",
        "RING_BG": "rgba(148,163,184,0.15)", "PILL_BG": "rgba(176,0,16,0.28)",
        "PILL_STROKE": "rgba(255,90,95,0.5)", "MONO_TX": "#FFD1D1",
    },
    "light": {
        "BG": "#FFF7F7", "PANEL": "#FFFFFF", "PANEL_BAR": "#F1F5F9",
        "CYAN": "#0891B2", "VIOLET": "#B00010", "VIOLET2": "#B00010",
        "EMERALD": "#059669", "TEXT": "#0F172A", "MUTED": "#737373",
        "DIM": "#A3A3A3",
...
def set_theme(name):
    ...
    for k, v in t.items():
        g[k] = v
    g["DONUT_COLORS"] = [t["VIOLET"], t["CYAN"], t["EMERALD"], "#8B0000", "#737373", "#A3A3A3"]
